...
/**
 * @file val64-table-decoders.hpp
 * @author Andrew Cooper
 */

#ifndef _VAL64_TABLE_DECODERS_HPP
#define _VAL64_TABLE_DECODERS_HPP
 ...
 */
class x64Val64TabDecoder: public Val64TabDecoder
{
public:
    /// Constructor
    x64Val64TabDecoder();
    /// Destructor
    virtual ~x64Val64TabDecoder();
...
#endif /* _VAL64_TABLE_DECODERS_HPP */
