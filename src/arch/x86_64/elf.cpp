...
namespace x86_64
{
    ...
    Elf::Elf(int fd):Abstract::Elf(fd){ this->arch = Abstract::Elf::ELF_64; }
    Elf::~Elf(){}
    ...
    bool Elf::parse_phdrs(const Elf64_Half & size, const Elf64_Off & offset)
    {
        Elf64_Phdr phdr;
        ssize_t r;
    ...
    bool Elf::parse_nhdrs(const ElfProgHdr & hdr)
    {
        Elf64_Nhdr * nhdr;
        ssize_t r, size;
